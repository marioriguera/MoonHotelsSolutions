...
{
    /// <summary>
    /// Represents a request for Spedia.
    /// </summary>
    internal class SpediaRequest : RequestBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpediaRequest"/> class with the specified parameters.
        /// </summary>
        ...
        public SpediaRequest(int id, int hotel, DateTime checkInDate, int numberOfNights, int guests, int rooms, CurrencyType currency, bool hasWifi, bool hasDinner)
