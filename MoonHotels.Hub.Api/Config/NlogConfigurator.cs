    ...
    public class NlogConfigurator
    {
        ...
        public static void AddConsole()
        {
            ...
            if (logConsole == null)
            {
                ...
                LogManager.Configuration.AddRule(ApiConfigurationService.Current.LogLevel, NLog.LogLevel.Fatal, logConsole);
            }

            // Refresh log levels
            foreach (var rule in LogManager.Configuration.LoggingRules.Where(x => x.Targets.Contains(logConsole)))
            {
                rule.SetLoggingLevels(ApiConfigurationService.Current.LogLevel, NLog.LogLevel.Fatal);
            }
        ...
        public static void AddDebugger()
        {
            ...
            if (logDebugger == null)
            {
                ...
                LogManager.Configuration.AddRule(ApiConfigurationService.Current.LogLevel, NLog.LogLevel.Fatal, logDebugger);
            }
        ...
        public static void AddRollingFile()
        {
            ...
            if (logFile == null)
            {
                ...
                LogManager.Configuration.AddRule(ApiConfigurationService.Current.LogLevel, NLog.LogLevel.Fatal, logFile);
            }

            string fileName = ApiConfigurationService.Current.LogPath;
            string archiveName = Path.Combine(Path.GetDirectoryName(ApiConfigurationService.Current.LogPath) ?? string.Empty, Path.GetFileNameWithoutExtension(ApiConfigurationService.Current.LogPath) + ".zip");
            ...
            logFile.ArchiveAboveSize = ApiConfigurationService.Current.LogMaxFileSize;
        ...
        /// <summary>
        /// Reconfigures all loggers with configuration from <see cref="ApiConfigurationService"/>.
        /// </summary>
        public static void ApplyConfigurationToLogs()
        {
            ...
            if (!string.IsNullOrWhiteSpace(ApiConfigurationService.Current.LogPath))
            {
                AddRollingFile();
            }
